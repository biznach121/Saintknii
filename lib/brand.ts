...
export const brand: Brand = {
  name: "Saintknii Beauty & Massage",
  shortName: "Saintknii",
  microTag: "BEAUTY ENHANCEMENT AND MASSAGE",
  description:
    "Saintknii Beauty & Massage is a Accra massage studio built around one promise: you leave lighter than you came.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0249491573",
    phoneTel: "+233249491573",
    textPhone: "0249491573",
    textPhoneTel: "+233249491573",
    email: "hello@saintknii.test",
    privacyEmail: "privacy@saintknii.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@saintknii", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "saintly hands,\nheavenly results.\nBeauty enhancement and massage.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Saintknii Beauty & Massage was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Saintknii Beauty & Massage beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Saintknii Beauty & Massage self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Saintknii Beauty & Massage beauty ritual",
      ...
      },
      {
        ...
        alt: "Saintknii Beauty & Massage calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Saintknii Beauty & Massage relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Saintknii Beauty & Massage beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Saintknii Beauty & Massage lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Saintknii Beauty & Massage mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Saintknii Beauty & Massage makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Saintknii Beauty & Massage foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@saintknii",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783493384/stage4/spa_saintknii/tiktok_0.mp4",
        alt: "Saintknii Beauty & Massage treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581425/w22e5ae19sjiofurtmlm.mp4",
        alt: "Saintknii Beauty & Massage beauty media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Saintknii Beauty & Massage salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Saintknii Beauty & Massage self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Saintknii Beauty & Massage studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Saintknii Beauty & Massage",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Saintknii Beauty & Massage is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0249491573 and text 0249491573 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0249491573, text 0249491573, or message @saintknii on Instagram." },
          ...
          { q: "Where are you located?", a: "Saintknii Beauty & Massage is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@saintknii.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Saintknii Beauty & Massage (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@saintknii.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Saintknii Beauty & Massage is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@saintknii.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Saintknii Beauty & Massage",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0249491573", href: "tel:+233249491573" },
      { label: "Text", value: "0249491573", href: "sms:+233249491573" },
      { label: "Instagram", value: "@saintknii", href: "https://www.tiktok.com/@saintknii" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783493376/stage4/spa_saintknii/avatar.jpg",
    blurb:
      "Saintknii Beauty & Massage in Accra — beauty enhancement and massage.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@saintknii" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0249491573", href: "tel:+233249491573" },
          { label: "Text 0249491573", href: "sms:+233249491573" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Saintknii Beauty & Massage — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },

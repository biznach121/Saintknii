    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1.4fr]">
      ...
      <div className="spabox-card flex flex-col p-5 sm:p-6">
        ...
        <label className="relative mb-3 block">
          ...
          <SearchIcon className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#638453]" />
          <input
            type="search"
            value={query}
            onChange={(event) => setQuery(event.target.value)}
            placeholder={searchPlaceholder}
            className="h-11 w-full rounded-full border border-[#422900]/14 bg-[#e9f4e5] pl-12 pr-4 text-sm font-medium text-[#422900] outline-none transition-colors placeholder:text-[#638453] focus:border-[#422900]/40"
          />
        </label>
          ...
          {filtered.length === 0 ? (
            <div className="rounded-[18px] border border-dashed border-[#422900]/20 p-6 text-center">
              ...
              <button
                ...
                className="mt-2 text-sm font-semibold text-[#638453] underline-offset-4 hover:underline"
              >
                Reset
              </button>
            </div>
      ...
      <div className="spabox-card p-4 sm:p-6">
        ...
        <button
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 bg-[#422900] px-5 py-3 text-sm font-semibold text-[#e9f4e5] transition-colors hover:bg-[#301e00] disabled:cursor-not-allowed disabled:opacity-50"
        >
          {submitting
            ? "Confirming…"
            : selectedSlot
